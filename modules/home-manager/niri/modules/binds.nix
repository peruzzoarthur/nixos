{ ... }: {
  wayland.windowManager.niri.settings.binds = {
    ...
    "Mod+E" = {
      _props = {
        hotkey-overlay-title = "Run an Application: yazi";
      };
      spawn = [ "kitty" "yazi" ];
    };
    "Mod+P" = {
      _props = {
        hotkey-overlay-title = "Run an Application: btop";
      };
      spawn = [ "kitty" "btop" ];
    };
    "Mod+M" = {
      _props = {
        hotkey-overlay-title = "wlr-which-key";
      };
      spawn = [ "wlr-which-key" ];
    };
    "Mod+Space" = {
      ...
      spawn-sh = [ "test -S /tmp/mykitty && kitty || kitty --listen-on unix:/tmp/mykitty" ];
    };
    "Super+Alt+L" = {
      _props = {
    ...
    "Mod+N" = {
      _props = {
        hotkey-overlay-title = "Run an Application: coldnote";
      };
      spawn-sh = [ "kitty bun run ~/coldLab/tui/cold-note-opentui/src/index.tsx" ];
    };
    "Mod+Shift+P" = {
      _props = {
        hotkey-overlay-title = "Noctalia control center";
      };
      spawn-sh = [ "noctalia-shell ipc call systemMonitor toggle" ];
    };
    "Alt+C" = {
      spawn-sh = [ "wlrctl pointer click left" ];
    };
    ...
    # Switch keyboard layout with Alt+Space
    "Shift+Ctrl+K" = {
      switch-layout = [ "next" ];
    };
